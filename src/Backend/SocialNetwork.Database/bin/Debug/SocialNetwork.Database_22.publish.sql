...
CREATE TABLE [dbo].[tmp_ms_xx_Comment] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_Pk_Comment_CommentId1] PRIMARY KEY CLUSTERED ([CommentId] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Comment])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Comment] ([NumberOfLikes], [PostId], [UserId])
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_Pk_Comment_CommentId1]', N'Pk_Comment_CommentId', N'OBJECT';
